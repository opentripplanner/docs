...
input TransitPreferencesInput {
  ...
  **AND/OR Logic**
  ...
  Be aware of the following pitfalls:
    ...
    - OR-conditions that have one element which consists of only an exclude are likely to be
