...
`+this.renderer.text(f);t?a+=this.renderer.paragraph({type:"paragraph",raw:h,text:h,tokens:[{type:"text",raw:h,text:h}]}):a+=h;continue}default:{const f='Token with "'+u.type+'" type was not found.';if(this.options.silent)return console.error(f),"";throw new Error(f)}}}return a}parseInline(n,t){t=t||this.renderer;let a="";for(let s=0;s<n.length;s++){const o=n[s];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[o.type]){const f=this.options.extensions.renderers[o.type].call({parser:this},o);if(f!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(o.type)){a+=f||"";continue}}const u=o;switch(u.type){case"escape":{a+=t.text(u);break}case"html":{a+=t.html(u);break}case"link":{a+=t.link(u);break}case"image":{a+=t.image(u);break}case"strong":{a+=t.strong(u);break}case"em":{a+=t.em(u);break}case"codespan":{a+=t.codespan(u);break}case"br":{a+=t.br(u);break}case"del":{a+=t.del(u);break}case"text":{a+=t.text(u);break}default:{const f='Token with "'+u.type+'" type was not found.';if(this.options.silent)return console.error(f),"";throw new Error(f)}}}return a}}class pr{constructor(n){ve(this,"options");ve(this,"block");this.options=n||mi}preprocess(n){return n}postprocess(n){return n}processAllTokens(n){return n}provideLexer(){return this.block?Fn.lex:Fn.lexInline}provideParser(){return this.block?$n.parse:$n.parseInline}}ve(pr,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens"]));class m0{constructor(...n){ve(this,"defaults",$o());ve(this,"options",this.setOptions);ve(this,"parse",this.parseMarkdown(!0));ve(this,"parseInline",this.parseMarkdown(!1));ve(this,"Parser",$n);ve(this,"Renderer",Na);ve(this,"TextRenderer",jo);ve(this,"Lexer",Fn);ve(this,"Tokenizer",Fa);ve(this,"Hooks",pr);this.use(...n)}walkTokens(n,t){var s,o;let a=[];for(const u of n)switch(a=a.concat(t.call(this,u)),u.type){case"table":{const f=u;for(const h of f.header)a=a.concat(this.walkTokens(h.tokens,t));for(const h of f.rows)for(const m of h)a=a.concat(this.walkTokens(m.tokens,t));break}case"list":{const f=u;a=a.concat(this.walkTokens(f.items,t));break}default:{const f=u;(o=(s=this.defaults.extensions)==null?void 0:s.childTokens)!=null&&o[f.type]?this.defaults.extensions.childTokens[f.type].forEach(h=>{const m=f[h].flat(1/0);a=a.concat(this.walkTokens(m,t))}):f.tokens&&(a=a.concat(this.walkTokens(f.tokens,t)))}}return a}use(...n){const t=this.defaults.extensions||{renderers:{},childTokens:{}};return n.forEach(a=>{const s={...a};if(s.async=this.defaults.async||s.async||!1,a.extensions&&(a.extensions.forEach(o=>{if(!o.name)throw new Error("extension name required");if("renderer"in o){const u=t.renderers[o.name];u?t.renderers[o.name]=function(...f){let h=o.renderer.apply(this,f);return h===!1&&(h=u.apply(this,f)),h}:t.renderers[o.name]=o.renderer}if("tokenizer"in o){if(!o.level||o.level!=="block"&&o.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");const u=t[o.level];u?u.unshift(o.tokenizer):t[o.level]=[o.tokenizer],o.start&&(o.level==="block"?t.startBlock?t.startBlock.push(o.start):t.startBlock=[o.start]:o.level==="inline"&&(t.startInline?t.startInline.push(o.start):t.startInline=[o.start]))}"childTokens"in o&&o.childTokens&&(t.childTokens[o.name]=o.childTokens)}),s.extensions=t),a.renderer){const o=this.defaults.renderer||new Na(this.defaults);for(const u in a.renderer){if(!(u in o))throw new Error(`renderer '${u}' does not exist`);if(["options","parser"].includes(u))continue;const f=u,h=a.renderer[f],m=o[f];o[f]=(...y)=>{let b=h.apply(o,y);return b===!1&&(b=m.apply(o,y)),b||""}}s.renderer=o}if(a.tokenizer){const o=this.defaults.tokenizer||new Fa(this.defaults);for(const u in a.tokenizer){if(!(u in o))throw new Error(`tokenizer '${u}' does not exist`);if(["options","rules","lexer"].includes(u))continue;const f=u,h=a.tokenizer[f],m=o[f];o[f]=(...y)=>{let b=h.apply(o,y);return b===!1&&(b=m.apply(o,y)),b}}s.tokenizer=o}if(a.hooks){const o=this.defaults.hooks||new pr;for(const u in a.hooks){if(!(u in o))throw new Error(`hook '${u}' does not exist`);if(["options","block"].includes(u))continue;const f=u,h=a.hooks[f],m=o[f];pr.passThroughHooks.has(u)?o[f]=y=>{if(this.defaults.async)return Promise.resolve(h.call(o,y)).then(O=>m.call(o,O));const b=h.call(o,y);return m.call(o,b)}:o[f]=(...y)=>{let b=h.apply(o,y);return b===!1&&(b=m.apply(o,y)),b}}s.hooks=o}if(a.walkTokens){const o=this.defaults.walkTokens,u=a.walkTokens;s.walkTokens=function(f){let h=[];return h.push(u.call(this,f)),o&&(h=h.concat(o.call(this,f))),h}}this.defaults={...this.defaults,...s}}),this}setOptions(n){return this.defaults={...this.defaults,...n},this}lexer(n,t){return Fn.lex(n,t??this.defaults)}parser(n,t){return $n.parse(n,t??this.defaults)}parseMarkdown(n){return(a,s)=>{const o={...s},u={...this.defaults,...o},f=this.onError(!!u.silent,!!u.async);if(this.defaults.async===!0&&o.async===!1)return f(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof a>"u"||a===null)return f(new Error("marked(): input parameter is undefined or null"));if(typeof a!="string")return f(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(a)+", string expected"));u.hooks&&(u.hooks.options=u,u.hooks.block=n);const h=u.hooks?u.hooks.provideLexer():n?Fn.lex:Fn.lexInline,m=u.hooks?u.hooks.provideParser():n?$n.parse:$n.parseInline;if(u.async)return Promise.resolve(u.hooks?u.hooks.preprocess(a):a).then(y=>h(y,u)).then(y=>u.hooks?u.hooks.processAllTokens(y):y).then(y=>u.walkTokens?Promise.all(this.walkTokens(y,u.walkTokens)).then(()=>y):y).then(y=>m(y,u)).then(y=>u.hooks?u.hooks.postprocess(y):y).catch(f);try{u.hooks&&(a=u.hooks.preprocess(a));let y=h(a,u);u.hooks&&(y=u.hooks.processAllTokens(y)),u.walkTokens&&this.walkTokens(y,u.walkTokens);let b=m(y,u);return u.hooks&&(b=u.hooks.postprocess(b)),b}catch(y){return f(y)}}}onError(n,t){return a=>{if(a.message+=`
Please report this to https://github.com/markedjs/marked.`,n){const s="<p>An error occurred:</p><pre>"+_n(a.message+"",!0)+"</pre>";return t?Promise.resolve(s):s}if(t)return Promise.reject(a);throw a}}}const fi=new m0;function be(i,n){return fi.parse(i,n)}be.options=be.setOptions=function(i){return fi.setOptions(i),be.defaults=fi.defaults,Nf(be.defaults),be};be.getDefaults=$o;be.defaults=mi;be.use=function(...i){return fi.use(...i),be.defaults=fi.defaults,Nf(be.defaults),be};be.walkTokens=function(i,n){return fi.walkTokens(i,n)};be.parseInline=fi.parseInline;be.Parser=$n;be.parser=$n.parse;be.Renderer=Na;be.TextRenderer=jo;be.Lexer=Fn;be.lexer=Fn.lex;be.Tokenizer=Fa;be.Hooks=pr;be.parse=be;be.options;be.setOptions;be.use;be.walkTokens;be.parseInline;$n.parse;Fn.lex;function y0(i){return new Fn().lex(i)}const v0=()=>({heading:LT,blockquote:UT,list:GT,list_item:qT,br:HT,code:JT,codespan:ZT,table:tw,html:aw,paragraph:lw,link:fw,text:pw,def:yw,del:Tw,em:Ew,hr:Aw,strong:kw,image:Ow,space:Qc,escape:Qc}),b0=()=>({baseUrl:"/",slugger:new kf});function T0(){const i=console.warn;console.warn=n=>{n.includes("unknown prop")||n.includes("unexpected slot")||i(n)},IT(()=>{console.warn=i})}function w0(i){let n,t;return n=new Ua({props:{tokens:i[0],renderers:i[1],options:i[2]}}),{c(){Ht(n.$$.fragment)},l(a){gi(n.$$.fragment,a)},m(a,s){zt(n,a,s),t=!0},p(a,[s]){const o={};s&1&&(o.tokens=a[0]),s&2&&(o.renderers=a[1]),s&4&&(o.options=a[2]),n.$set(o)},i(a){t||(ee(n.$$.fragment,a),t=!0)},o(a){se(n.$$.fragment,a),t=!1},d(a){jt(n,a)}}}function D0(i,n,t){T0();let{source:a}=n,{options:s={}}=n,{renderers:o={}}=n,u,f,h;return i.$$set=m=>{"source"in m&&t(3,a=m.source),"options"in m&&t(4,s=m.options),"renderers"in m&&t(5,o=m.renderers)},i.$$.update=()=>{i.$$.dirty&56&&(t(0,u=y0(a)),t(1,f={...v0(),...o}),t(2,h={...b0(),...s}))},[u,f,h,a,s,o]}class SI extends Pe{constructor(n){super(),Be(this,n,D0,w0,ke,{source:3,options:4,renderers:5})}}const Sr={joinUrlPaths:vr,isRelative:br,generatePathSegment:Ff};var ur=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function E0(i){return i&&i.__esModule&&Object.prototype.hasOwnProperty.call(i,"default")?i.default:i}var Ca={exports:{}};/**
 * @license
...
`,hn=hI(),xo=Ga($a.DIRECTIVES,[]);var Df;const eI=za((Df=hn.getQueryType())==null?void 0:Df.getFields());var Ef;const nI=za((Ef=hn.getMutationType())==null?void 0:Ef.getFields());var If;const tI=za((If=hn.getSubscriptionType())==null?void 0:If.getFields()),il=Nt.keyBy(Rh(),i=>i.name.toLocaleLowerCase()),iI=Nt.mapValues(il,i=>{const n=xo.find(t=>(t==null?void 0:t.name)===i.name||(t==null?void 0:t.name)==="*");return n?n.args.some(t=>t==="*")?i.args:n.args.map(t=>i.args.find(a=>a.name===t)).filter(t=>!!t):[]}),rI=za(hn.getTypeMap()),aI=JE(hn);function za(i){return Nt.mapKeys(i||{},(n,t)=>t.toLocaleLowerCase())}function sI(){return Nt.size(hn.getTypeMap())<=10}function oI(){return[Io("Queries",hn.getQueryType()),Io("Mutations",hn.getMutationType()),Io("Subscriptions",hn.getSubscriptionType()),dI(),cI()].filter(i=>!!i)}function Io(i,n){return uI(i,lI(n))}function lI(i){return Nt.sortBy((i==null?void 0:i.getFields())||{},n=>n.name)}function uI(i,n){return n.length===0?null:{type:"menu",title:i,children:n.map(t=>({type:"page",title:t.name,section:i,deprecated:!!t.deprecationReason,href:Sr.joinUrlPaths(Va(),i.toLocaleLowerCase(),t.name)}))}}function cI(){return sI()?null:{type:"menu",title:"Types",children:Nt.sortBy(Nt.map(hn.getTypeMap()),n=>n.name).filter(n=>!n.name.startsWith("__")).map(n=>({type:"page",title:n.name,section:"Types",href:Sr.joinUrlPaths(Va(),"types",n.name)}))}}function FI(){return!!hn.getQueryType()}function kI(i){return eI[i.toLocaleLowerCase()]}function NI(){return!!hn.getMutationType()}function CI(i){return nI[i.toLocaleLowerCase()]}function OI(){return!!hn.getSubscriptionType()}function RI(i){return tI[i.toLocaleLowerCase()]}function xI(i){return rI[i.toLocaleLowerCase()]}function fI(i){return il[i.toLocaleLowerCase()]}function LI(i){return fI(i.name)!==void 0}function PI(){return Nt.size(il)>0}function BI(i){return iI[i.name.toLocaleLowerCase()]||[]}function UI(i){if(i)return aI.getFor(i)}function MI(i){return Nt.flatMap(i.getFields(),n=>({field:n,possibleDescriptions:Oh(n,i)}))}function Oh(i,n){return i?i.description?[{description:i.description,from:n}]:Ye(n)?n.getInterfaces().flatMap(t=>Oh(t.getFields()[i.name],t)):[]:[]}function Rh(){return xo.some(i=>(i==null?void 0:i.name)==="*")?hn.getDirectives().filter(i=>!["include","skip","deprecated","specifiedBy"].includes(i.name)):xo.filter(i=>!!(i!=null&&i.name)).map(({name:i})=>i?hn.getDirective(i):void 0).filter(i=>!!i)}function hI(){return Tf.trim().length===0?YE(JSON.parse(JSON.stringify({__schema:{types:[]}}))):QE(Tf)}function dI(){const i=Rh();return i.length===0?null:{type:"menu",title:"Directives",children:i.map(n=>({type:"page",title:n.name,href:Sr.joinUrlPaths(Va(),"directives",n.name),section:"Directives"}))}}const $I=Ga($a.APP_TITLE,"GraphQL Documentation"),xh=gI().concat(oI());yI(xh);const pI=Object.freeze(xh),GI=mI();function gI(){return Ga($a.PAGES,bI()).filter(n=>!!n).map(n=>Ph([],n))}function mI(){const i=vI();if(i)return i.href;throw new Error("No custom pages or query available to use as the root application URL. You need to provide at least one custom page or your schema should contain at least one query/mutation/subscription.")}function yI(i){function n(a,s){for(const o of a){if(o.type==="page"){s(o);continue}o.type==="menu"&&n(o.children,s)}}let t;n(i,a=>{t&&(t.next={title:a.title,section:a.section,href:a.href},a.previous={title:t.title,section:t.section,href:t.href}),t=a})}function vI(){return Lh(()=>!0)}function VI(i){return Lh(n=>n.href.toLocaleLowerCase()===i.toLocaleLowerCase())}function Lh(i){function n(t){for(const a of t){if(a.type==="page"&&i(a))return a;if(a.type==="menu"){const s=n(a.children);if(s)return s}}return null}return n(pI)}function Ph(i,n){if(typeof n.content=="string")return{type:"page",title:n.title,content:n.content,href:Sr.joinUrlPaths(Va(),...i,wf(n.title))};const t=i.concat([wf(n.title)]);return{type:"menu",title:n.title,children:n.content.map(a=>({...Ph(t,a),section:n.title}))}}function wf(i){return Sr.generatePathSegment(i,new kf)}function bI(){return[{title:"Introduction",content:[{title:"Welcome",content:`
        # Welcome 🎉
        ...
        `.split(`
`).map(i=>i.trim()).join(`
`)}]}]}export{E0 as A,sI as B,xI as C,UI as D,Jt as E,et as F,Ve as G,Vn as H,Ye as I,vn as J,w as K,MI as L,pi as M,Pi as N,AI as O,Ua as P,_f as Q,gr as R,SI as S,kf as T,be as U,Fn as V,$I as W,Nt as _,NI as a,FI as b,kI as c,OI as d,RI as e,VI as f,CI as g,GI as h,Af as i,II as j,PI as k,fI as l,BI as m,LI as n,Va as o,pI as p,ct as q,nh as r,hn as s,bn as t,Sr as u,Se as v,_I as w,Ga as x,$a as y,ur as z};
