...
`,1)[0];let xe;if(O=Qe,this.options.pedantic?(O=O.replace(/^ {1,4}(?=( {4})*[^ ])/g,"  "),xe=O):xe=O.replace(/\t/g,"    "),ye.test(O)||Re.test(O)||je.test(O)||ce.test(O)||Se.test(O))break;if(xe.search(/[^ ]/)>=F||!O.trim())y+=`
`+xe.slice(F);else{if(_||b.replace(/\t/g,"    ").search(/[^ ]/)>=4||ye.test(b)||Re.test(b)||Se.test(b))break;y+=`
`+O}!_&&!O.trim()&&(_=!0),m+=Qe+`
...
`,fn=fI(),xo=Ga($a.DIRECTIVES,[]);var wh;const eI=za((wh=fn.getQueryType())==null?void 0:wh.getFields());var Dh;const nI=za((Dh=fn.getMutationType())==null?void 0:Dh.getFields());var Eh;const tI=za((Eh=fn.getSubscriptionType())==null?void 0:Eh.getFields()),il=Nt.keyBy(Rf(),i=>i.name.toLocaleLowerCase()),iI=Nt.mapValues(il,i=>{const n=xo.find(t=>(t==null?void 0:t.name)===i.name||(t==null?void 0:t.name)==="*");return n?n.args.some(t=>t==="*")?i.args:n.args.map(t=>i.args.find(a=>a.name===t)).filter(t=>!!t):[]}),rI=za(fn.getTypeMap()),aI=JE(fn);function za(i){return Nt.mapKeys(i||{},(n,t)=>t.toLocaleLowerCase())}function sI(){return Nt.size(fn.getTypeMap())<=10}function oI(){return[Io("Queries",fn.getQueryType()),Io("Mutations",fn.getMutationType()),Io("Subscriptions",fn.getSubscriptionType()),dI(),cI()].filter(i=>!!i)}function Io(i,n){return uI(i,lI(n))}function lI(i){return Nt.sortBy((i==null?void 0:i.getFields())||{},n=>n.name)}function uI(i,n){return n.length===0?null:{type:"menu",title:i,children:n.map(t=>({type:"page",title:t.name,section:i,deprecated:!!t.deprecationReason,href:Ar.joinUrlPaths(Va(),i.toLocaleLowerCase(),t.name)}))}}function cI(){return sI()?null:{type:"menu",title:"Types",children:Nt.sortBy(Nt.map(fn.getTypeMap()),n=>n.name).filter(n=>!n.name.startsWith("__")).map(n=>({type:"page",title:n.name,section:"Types",href:Ar.joinUrlPaths(Va(),"types",n.name)}))}}function FI(){return!!fn.getQueryType()}function kI(i){return eI[i.toLocaleLowerCase()]}function NI(){return!!fn.getMutationType()}function CI(i){return nI[i.toLocaleLowerCase()]}function OI(){return!!fn.getSubscriptionType()}function RI(i){return tI[i.toLocaleLowerCase()]}function xI(i){return rI[i.toLocaleLowerCase()]}function hI(i){return il[i.toLocaleLowerCase()]}function LI(i){return hI(i.name)!==void 0}function PI(){return Nt.size(il)>0}function BI(i){return iI[i.name.toLocaleLowerCase()]||[]}function UI(i){if(i)return aI.getFor(i)}function MI(i){return Nt.flatMap(i.getFields(),n=>({field:n,possibleDescriptions:Of(n,i)}))}function Of(i,n){return i?i.description?[{description:i.description,from:n}]:Ye(n)?n.getInterfaces().flatMap(t=>Of(t.getFields()[i.name],t)):[]:[]}function Rf(){return xo.some(i=>(i==null?void 0:i.name)==="*")?fn.getDirectives().filter(i=>!["include","skip","deprecated","specifiedBy"].includes(i.name)):xo.filter(i=>!!(i!=null&&i.name)).map(({name:i})=>i?fn.getDirective(i):void 0).filter(i=>!!i)}function fI(){return bh.trim().length===0?YE(JSON.parse(JSON.stringify({__schema:{types:[]}}))):QE(bh)}function dI(){const i=Rf();return i.length===0?null:{type:"menu",title:"Directives",children:i.map(n=>({type:"page",title:n.name,href:Ar.joinUrlPaths(Va(),"directives",n.name),section:"Directives"}))}}const $I=Ga($a.APP_TITLE,"GraphQL Documentation"),xf=gI().concat(oI());yI(xf);const pI=Object.freeze(xf),GI=mI();function gI(){return Ga($a.PAGES,bI()).filter(n=>!!n).map(n=>Pf([],n))}function mI(){const i=vI();if(i)return i.href;throw new Error("No custom pages or query available to use as the root application URL. You need to provide at least one custom page or your schema should contain at least one query/mutation/subscription.")}function yI(i){function n(a,s){for(const o of a){if(o.type==="page"){s(o);continue}o.type==="menu"&&n(o.children,s)}}let t;n(i,a=>{t&&(t.next={title:a.title,section:a.section,href:a.href},a.previous={title:t.title,section:t.section,href:t.href}),t=a})}function vI(){return Lf(()=>!0)}function VI(i){return Lf(n=>n.href.toLocaleLowerCase()===i.toLocaleLowerCase())}function Lf(i){function n(t){for(const a of t){if(a.type==="page"&&i(a))return a;if(a.type==="menu"){const s=n(a.children);if(s)return s}}return null}return n(pI)}function Pf(i,n){if(typeof n.content=="string")return{type:"page",title:n.title,content:n.content,href:Ar.joinUrlPaths(Va(),...i,Th(n.title))};const t=i.concat([Th(n.title)]);return{type:"menu",title:n.title,children:n.content.map(a=>({...Pf(t,a),section:n.title}))}}function Th(i){return Ar.generatePathSegment(i,new Fh)}function bI(){return[{title:"Introduction",content:[{title:"Welcome",content:`
        ...
        `.split(`
`).map(i=>i.trim()).join(`
`)}]}]}export{E0 as A,sI as B,xI as C,UI as D,Jt as E,et as F,Ve as G,Vn as H,Ye as I,vn as J,w as K,MI as L,pi as M,Pi as N,SI as O,Ua as P,Sh as Q,gr as R,AI as S,Fh as T,be as U,Fn as V,$I as W,Nt as _,NI as a,FI as b,kI as c,OI as d,RI as e,VI as f,CI as g,GI as h,Ah as i,II as j,PI as k,hI as l,BI as m,LI as n,Va as o,pI as p,ct as q,ef as r,fn as s,bn as t,Ar as u,Ae as v,_I as w,Ga as x,$a as y,ur as z};
